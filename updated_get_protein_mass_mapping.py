...
#1) line importing submodules: autopacmen.submodules.helper_general import ...
#2) API 
#3) added lines as the end, so function will execute when file is run from terminal
#
#!/usr/bin/env python3
#
...
# Internal modules
from autopacmen.submodules.helper_general import ensure_folder_existence, get_files, json_write, pickle_write, pickle_load, standardize_folder
...
sbml_path = "/home/kn/vscode/python3/FBA/autoPac/hESCNet_test.xml"
