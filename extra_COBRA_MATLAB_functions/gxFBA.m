...
%
%NOTE: This is a modified version of the original gxFBA function that does
%not use interior point solver. Only intended for NTNU course TBT4165.
%
%USAGE
...
%
% iter             Number of samples of alternative optimal FBA reference
%                    flux states to estimate effect of these alternative optimal
%                    solutions in the reference state flux on GX-FBA result
%                    (default = 0).
%
...
if iter > 0
    ...
    if (ent > 0)
        ...
        for i=1:iter
            ...
            alt_f    = optimizeCbModel(model_it,'max'); 
            ...
            itsol               = optimizeCbModel(gxfba_it,'max');
            Zgx(i)              = itsol.f;
