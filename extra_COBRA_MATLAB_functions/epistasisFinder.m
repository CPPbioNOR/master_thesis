function [interactions,epistaticEffect] = epistasisFinder(doubleDeletionFitness,lethalFlag,minEffect)
...
%
% [interactions,epistaticEffect] = epistasisFinder(doubleDeletionFitness,lethalFlag,minEffect)
%
%INPUTS
...
if (size(find(isnan(doubleDeletionFitness) > 0),1) > 0)
        l=find(isnan(doubleDeletionFitness));
        doubleDeletionFitness(l) = 0;
end

nGenes = size(doubleDeletionFitness,1);
